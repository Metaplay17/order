...
const projects_types = ["Изготовление металлоконструкций", "Дизайн проекты (флиппинг)", "Ремонт жилых помещений", "Ремонт коммерческих помещений"];
...
const projects: Project[] = [
  ...
  },
  {
    ...
    type: "Ремонт коммерческих помещений",
